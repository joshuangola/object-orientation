...
/*
  ...
  with the value being your favorite car and then another key named 'show' with the value being your 
  favorite show.
*/

//Code here
favoriteThings.car = "Raptor R";
...
//Code here
favoriteThings.food = "Pulled pork";
favoriteThings.book = "Kings Dark Tidings";
...
const person = {firstName: "josh", lastName: "nash", title: "alpha"};
...
const dinner1 = {carb: 'rice', fat: 'avacado', protein: 'tuna'};
console.log(ingredients(dinner1));
...
const myCat = new Cat('Butch', 1, 'silver');
...
class Wizard {
  ...
  const lith = new Wizard('Lith Verhen', 16, 'Checkmate Spears');
lith.castSpell();
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
//Code Here
const iPhone = new Phone("Apple", "iPhone 11", 11, "black", 799);
const Galaxy = new Phone("Samsung", "Galaxy S20", 20, "blue", 999);
const Pixel = new Phone("Google", "Pixel 4", 4, "white", 699);
...
//Code Here
const myFirstVehicle = new Vehicle(5, 'red', 0);
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(1, 'black', 20, 'Harly', 'Very');

/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/

myFirstMotorcycle.move(25);
...
//Code Here
const myFirstBoat = new Boat(8, 'red', 0, 'Lightning', 'Speedboat', false);
/*
